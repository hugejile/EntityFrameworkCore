...
namespace Microsoft.EntityFrameworkCore.Proxies.Internal
{
    ...
    public class ProxyBindingRewriter : IModelBuiltConvention
    {
        ...
        private static FactoryMethodConstructorBinding RewriteToFactoryBinding(ConstructorBinding currentBinding)
            => new FactoryMethodConstructorBinding(
                ProxyFactory.Instance,
                typeof(ProxyFactory).GetTypeInfo().GetDeclaredMethod(nameof(ProxyFactory.CreateLazyLoader)),
